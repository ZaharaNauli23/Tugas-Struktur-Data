...
// Masukkan item ke DQueue di bagian belakang (rear)
...
// Hapus item dari DQueue di bagian depan (front)
...
// Untuk memasukkan item ke dalam DQueue di bagian depan (front)
...
// Untuk menghapus item dari DQueue di bagian belakang (rear)
